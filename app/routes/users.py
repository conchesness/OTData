...
def before_request():
    ...
    studentPaths = ['/assignments','/comp','/help','/breakstart','/postgrad','/cc','/plan','/profile','/editprofile','/addadult','/editadult','/deleteadult','/sendstudentemail','/checkin','/deletecheckin','/editgclass','/deletegclass','/gclasses','/comp','/missingassignmentsstu'] 
